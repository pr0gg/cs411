...
def create_meal(meal: str, cuisine: str, price: float, difficulty: str) -> None:
    ...
    Args:
        ...
        cuisine(str): The type of cuisine the meal belongs under.
        price(float): The price of the meal in dollars.
        difficulty (str): The difficulty rating of the meal.
...
def delete_meal(meal_id: int) -> None:
    """
    Soft deletes a meal from the list by marking it as deleted.
...
def get_leaderboard(sort_by: str="wins") -> dict[str, Any]:
    """
    Shows the meals leaderboard in order of descending wins and diplays meal details.

    Args:
        sort_by (str='wins'): The parameter to sort by.

    Raises:
        ValueError: If the sort-by parameter is not 'wins' or 'win_pct'.
        sqlite3.Error: If any database error occurs.
    """
    query = """
...
def get_meal_by_id(meal_id: int) -> Meal:
    """
    Retrieves a meal from the list by its meal ID.
...
def get_meal_by_name(meal_name: str) -> Meal:
    """
    Retrieves a meal from the list by its name.

    Args:
        meal_name (int): The name of the meal to retrieve.
...
def update_meal_stats(meal_id: int, result: str) -> None:
    """
    Determines whether to increment the win count of a meal by meal ID.

    Args:
        meal_id (int): The ID of the meal whose win count should be updated.
        result (str): The outcome of the meal clash which determines whether to increment the win count.
